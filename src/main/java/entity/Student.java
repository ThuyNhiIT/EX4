...
//@AttributeOverrides({ @AttributeOverride(name = "id", column = @jakarta.persistence.Column(name = "PersonID")),
//		@AttributeOverride(name = "firstName", column = @jakarta.persistence.Column(name = "FirstName")),
//		@AttributeOverride(name = "lastName", column = @jakarta.persistence.Column(name = "LastName")) })
